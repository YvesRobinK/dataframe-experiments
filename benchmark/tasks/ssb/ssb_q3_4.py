...
class Query_3_4(Ssb):
    ...
    def pandas_execution(self):
        ...
        self.joined = self.joined.loc[(self.joined['C_CITY'] == 'UNITED KI1') | (self.joined['C_CITY'] == 'UNITED KI5')]
        ...
        self.joined = self.joined.loc[self.joined['D_YEARMONTH'] == 'Dec1997']
    ...
    def polars_execution(self):
        ...
        self.joined = self.joined.filter(self.executor.module.col('D_YEARMONTH') == "Dec1997")
    ...
    def dask_execution(self):
        ...
        self.joined = self.joined[self.joined['D_YEARMONTH'] == 'Dec1997']
