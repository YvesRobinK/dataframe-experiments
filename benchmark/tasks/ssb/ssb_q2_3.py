...
class Query_2_3(Ssb):
    ...
    def pandas_execution(self):
        ...
        self.joined = self.joined.loc[self.joined['P_BRAND1'] == 'MFGR#2221']
        self.joined = self.joined.loc[self.joined['S_REGION'] == 'EUROPE']
        self.joined = self.joined[["D_YEAR", "P_BRAND1", "LO_REVENUE"]]
    ...
    def polars_execution(self):
        ...
        self.joined = self.joined.filter(self.executor.module.col('P_BRAND1') == "MFGR#2221")
        self.joined = self.joined.filter(self.executor.module.col('S_REGION') == "EUROPE")
    ...
    def dask_execution(self):
        ...
        self.joined = self.joined[self.joined['P_BRAND1'] == 'MFGR#2221']
        self.joined = self.joined[self.joined['S_REGION'] == "EUROPE"]
