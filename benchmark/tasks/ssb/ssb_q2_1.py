...
class Query_2_1(Ssb):
    ...
    def pandas_execution(self):
        ...
        self.joined = self.joined.loc[self.joined['P_CATEGORY'] == 'MFGR#12']
    ...
    def polars_execution(self):
        ...
        self.joined = self.joined.filter(self.executor.module.col('P_CATEGORY') == "MFGR#12")
    ...
    def dask_execution(self):
        ...
        self.joined = self.joined[self.joined['P_CATEGORY'] == "MFGR#12"]
