...
class Query_3_2(Ssb):
    ...
    def pandas_execution(self):
        ...
        self.joined = self.joined.loc[self.joined['C_NATION'] == 'UNITED STATES']
    ...
    def polars_execution(self):
        ...
        self.joined = self.joined.filter(self.executor.module.col('C_NATION') == "UNITED STATES")
    ...
    def dask_execution(self):
        ...
        self.joined = self.joined[self.joined['C_NATION'] == "UNITED STATES"]
